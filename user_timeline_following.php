...
$followinguser=  mysql_query("select *from follow f,user_register u where f.user_following_id=u.user_register_id and f.user_register_id='$user_id'");
$followingphotographer= mysql_query("select *from follow f,photographer_register u where f.photographer_register_id=u.photographer_register_id and f.user_following_id='$user_id'");
...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" type="image/png" href="images/logo/wild/wild/16X16.png"/>
	</head>
  <body>
    <!-- Header
    ================================================= -->
            ...
            <div class="row">
              ...
              <div class="col-md-9">
               <ul class="list-inline profile-menu">
                    ...
                    <li><a href="user_timeline_following.php" class="active">Following</a></li>
                </ul>
