...
This is a short list of our most frequently asked questions. For more information about wildphy, or if you need support, please visit our support center.

<br><br><b>What is wildphy?</b><br><br>

wildphy is a fun and quirky way to share your life with friends through a series of pictures. Snap a photo with your mobile phone, then choose a filter to transform the image into a memory to keep around forever. We're building wildphy to allow you to experience moments in your friends' lives through pictures as they happen. We imagine a world more connected through photos.
...
We love taking photos. We always assumed taking interesting photos required a big bulky camera and a couple years of art school. But as mobile phone cameras got better and better, we decided to challenge that assumption. We created wildphy to solve three simple problems:
...
We have adopted a follower model that means if you're "public" on wildphy, anyone can subscribe to follow your photos. We do, however, have a special private option. In this mode, a user can make sure he/she must approve all follow requests before they go through.

<br><br><b>Who can see my photos?</b><br><br>

All photos are public by default which means they are visible to anyone using wildphy or on the wildphy.com website. If you choose to make your account private, then only people who follow you on wildphy will be able to see your photos.

<br><br><b>How can I print my photos?</b><br><br>

We save all the photos you process with wildphy to your camera roll. You can then sync with your computer and print as many as you'd like.
