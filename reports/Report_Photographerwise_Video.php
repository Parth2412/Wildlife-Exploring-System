...
<table align="center" border="1">
  ...
  $q = mysql_query("select * from videos p , photographer_register pr where p.photographer_register_id=pr.photographer_register_id and p.photographer_register_id='$photographer'");
  while($data = mysql_fetch_row($q))
  {
      ...
      echo "<td> <video src='/admin/pphotos/$data[3]'></video> </td>";
      echo "</tr>";
  }
