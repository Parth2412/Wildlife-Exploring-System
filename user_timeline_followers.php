...
$followersuser=  mysql_query("select *from follow f,user_register u where f.user_register_id=u.user_register_id and f.user_following_id='$user_id'");
$followersphotographer=  mysql_query("select *from follow f,photographer_register u where f.photographer_register_id=u.photographer_register_id and f.user_following_id='$user_id'");
?>
...
<!--              <ul class="nav navbar-nav navbar-right main-menu">
    ...
    <div class="container">
      ...
      ================================================= -->
      <div class="timeline">
        <div class="timeline-cover" style="background:url('admin/pphotos/<?php  echo $user_grph['User_Cover_Photo'];?>') no-repeat; width:100%; background-size:cover;"
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                    ...
                    <li><a href="user_timeline_followers.php" class="active">Followers</a></li>
          ...
          <div class="navbar-mobile hidden-lg hidden-md">
            ...
            <div class="mobile-menu">
              <ul class="list-inline">
                <li><a href="use_timline.php">Timeline</a></li>
                <li><a href="user_timeline_about.php">About</a></li>
                <li><a href="user_timeline_album.php">Album</a></li>
                  <li><a href="user_timeline_followers.php" class="active">Followers</a></li>
                  <li><a href="user_timeline_following.php">Following</a></li>
            ...
            <div class="col-md-7">
              ...
              <div class="friend-list">
                <div class="row">
                        ...
                        <?php 
              while($followersdata=  mysql_fetch_row($followersuser))
              {
              ?>
                    ...
                    <div class="friend-card">
                      ...
                      ?>
                        ...
                        <?php 
              while($followersdata=  mysql_fetch_row($followersphotographer))
              {
              ?>
                    <div class="col-md-6 col-sm-6">
                    <div class="friend-card">
