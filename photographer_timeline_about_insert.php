...
if($_POST)
{
    ...
    $q=mysql_query("insert into photographer_editprofile (Photographer_PersonalInfo,Photographer_WorkExpr,Photographer_Location,Photographer_Languages,Photographer_Register_ID ) values('{$personalinfo}','{$workexpr}','{$location}','{$_languages}','{$photographer_id}')");
    if($q)
    {
        require 'admin/alertbox/alert.php';
    }   
...
<!--                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur</p>-->
                  ...
                  <div class="form-group">
                      <textarea id="contact-name" name="personalinfo" class="form-control" placeholder="Enter Your Persoanl Information" required="required" style="width:90%;"></textarea>    
...
<!--                  <div class="organization">
                ...
                <div class="about-content-block">
                  <h4 class="grey"><i class="ion-ios-location-outline icon-in-title"></i>Location</h4>
                    <div class="form-group">
<!--                      <textarea id="contact-name" name="workexperience" class="form-control" placeholder="Enter Your Work Experience" required="required" style="width:90%; "></textarea>    -->
                        <input id="contact-name" type="textarea" name="location" class="form-control" placeholder="Enter Your location" required="required" style="width:90%;"  >
                    </div>
                ...
                <div class="about-content-block">
                  <h4 class="grey"><i class="ion-ios-chatbubble-outline icon-in-title"></i>Language</h4>
                    <ul>
                        <div class="form-group">
<!--                      <textarea id="contact-name" name="workexperience" class="form-control" placeholder="Enter Your Work Experience" required="required" style="width:90%; "></textarea>    -->
                        <input id="contact-name" type="textarea" name="language" class="form-control" placeholder="Enter Languages Yoou Know" required="required" style="width:90%;"  >
                    </div>                    
                    </ul>
                </div>
