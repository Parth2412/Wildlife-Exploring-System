...
if($_POST)
{
   ...
   if($is_photographer=='Photographer'){
        ...
        $q = mysql_query("insert into photographer_register (Photographer_Fname,Photographer_Lname,Photographer_Gender,Photographer_City,Photographer_Email,Photographer_Pswd,Photographer_Mobile,Photographer_Picture) "
                . "values('{$fname}','{$lname}','{$gender}','{$city}','{$email}','{$password}','{$mobileno}','{$picture}')") or die(mysql_error());
   
       
   }else{
      
       
       $q = mysql_query("insert into user_register (User_Fname,User_Lname,User_Gender,User_City,User_Email,User_Pswd,User_Mobile,User_Picture)"
               . " values('{$fname}','{$lname}','{$gender}','{$city}','{$email}','{$password}','{$mobileno}','{$picture}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Registration Form</h2>
