...
$user_main = mysql_fetch_array($user);
...
<!-- Mirrored from thunder-team.com/friend-finder/timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Dec 2016 07:48:22 GMT -->
<head>
        ...
        <div class="container">
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <li class="dropdown">
                <a  class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Event Zone <span><img src="images/down-arrow.png" alt="" /></span></a>
                  <ul class="dropdown-menu newsfeed-home">
              ...
              ?>
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hi,&nbsp;<?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?>&nbsp;<span><img src="images/down-arrow.png" alt="" /></span></a>
                  <ul class="dropdown-menu newsfeed-home">
...
<!--              <ul class="nav navbar-nav navbar-right main-menu">
    ...
    <div class="container">
      ...
      ================================================= -->
      <div class="timeline">
        <div class="timeline-cover" style="background:url('admin/pphotos/<?php  echo $user_main['Photographer_Cover_Photo'];?>') no-repeat; width:100%; background-size:cover;"
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                 <ul class="list-inline profile-menu">
                    <li><a href="user_timeline.php" class="active">Timeline</a></li>
                  <li><a href="user_timeline_about.php">About</a></li>
          ...
          <div class="navbar-mobile hidden-lg hidden-md">
            ...
            <div class="mobile-menu">
              <ul class="list-inline">
                ...
                <li><a href="photographer_timeline_friends.php">Friends</a></li>
              </ul>
...
<!--              <div class="post-content">
                ...
                <div class="post-date hidden-xs hidden-sm">
                  <h5><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?></h5>
...
<!--<div class="post-date hidden-xs hidden-sm">
                  <h5>
                      <?php //echo $photo_grph['Photographer_Fname'].$photo_grph['Photographer_Lname']; ?>
</h5>
                  <p class="text-grey">Sometimes ago</p>
                </div>-->
 ...
 <?php 
            ...
            $getallphotosq = mysql_query("select * from photo ") or die(mysql_error());
            ...
            while($photodata = mysql_fetch_row($getallphotosq)) 
            {
               ...
               $photolikequery = mysql_query("select * from  photo_like where User_Register_ID = '{$user_id}'") or die(mysql_error());
...
<!--               Post Content
            ...
            <div class="col-md-2 static">
                ...
                <h4 class="grey"><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?>'s activity</h4>
                <div class="feed-item">
                  <div class="live-activity">
                    <p><a href="#" class="profile-link"><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?></a> Commended on a Photo</p>
                    <p class="text-muted">5 mins ago</p>
                  </div>
                </div>
                <div class="feed-item">
                  <div class="live-activity">
                    <p><a href="#" class="profile-link"><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?></a> Has posted a photo</p>
                    <p class="text-muted">an hour ago</p>
                  </div>
                </div>
                <div class="feed-item">
                  <div class="live-activity">
                    <p><a href="#" class="profile-link"><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?></a> Liked her friend's post</p>
                    <p class="text-muted">4 hours ago</p>
                  </div>
                </div>
                <div class="feed-item">
                  <div class="live-activity">
                    <p><a href="#" class="profile-link"><?php echo $user_main['User_Fname'].$user_main['User_Lname']; ?></a> has shared an album</p>
...
<!-- Mirrored from thunder-team.com/friend-finder/timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Dec 2016 07:50:15 GMT -->
</html>
