...
$followersuser=  mysql_query("select *from follow f,user_register u where f.user_register_id=u.user_register_id and f.photographer_following_id='$photographer_id'");
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                  ...
                  <li><a href="photographer_timeline_followers.php" class="active">Followers</a></li>
          ...
          <div class="navbar-mobile hidden-lg hidden-md">
            ...
            <div class="mobile-menu">
              <ul class="list-inline">
                ...
                <li><a href="photographer_timeline_about.php">About</a></li>
                <li><a href="photographer_timeline_album.php">Album</a></li>
                <li><a href="photographer_timeline_friends.php" class="active">Friends</a></li>
                  <li><a href="photographer_timeline_followers.php" class="active">Followers</a></li>
                  <li><a href="photographer_timeline_following.php">Following</a></li>
              </ul>
