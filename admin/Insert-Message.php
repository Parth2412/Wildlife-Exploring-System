...
if($_POST)
{
    $messagedesc=$_POST['messagedesc'];
    $messagedate=$_POST['messagedate'];
    $userid=$_POST['userid'];
    $photographerid=$_POST['photographerid'];
    
    
    $q = mysql_query("insert into message (Message_Desc,Message_Date,User_Register_ID,Photographer_Register_ID) values('{$messagedesc}','{$messagedate}','{$userid}','{$photographerid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Message Form</h2>
             <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Message Description:<input id="contact-name" type="text" name="messagedesc" class="form-control" placeholder="Enter Message Description*" required="required"  >
                    </div>
                      <div class="form-group">
                      
                      Message Date:<input id="contact-name" type="date" name="messagedate" class="form-control" placeholder="Enter Message Date*" required="required"  >
                    </div>
                       <div class="form-group">
