...
if($_POST)
{
    ...
    $q = mysql_query("insert into video_comment (Video_Comment_Date,Video_Desc,Photographer_Register_ID,Video_ID,User_Register_ID) values('{$commentdate}','{$commentdesc}','{$photographerid}','{$videoid}','{$userid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Video Comment Form</h2>
                 <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Video Comment Date:<input id="contact-name" type="date" name="commentdate" class="form-control" placeholder="Enter Date of Comment*" required="required"  >
                    </div>
                      <div class="form-group">
                      
                      Video Comment Description:<input id="contact-name" type="text" name="commentdesc" class="form-control" placeholder="Enter Comment for Video*" required="required"  >
                    </div>
                       <div class="form-group">
