...
if($_POST)
{
    ...
    $q = mysql_query("insert into blog (Blog_Date,Blog_Title,Blog_Desc,Photographer_Register_ID) values('{$blogdate}','{$blogtitle}','{$blogdesc}','{$photographerid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Blog Details Form</h2>
                  <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                        Blog Date:<input id="contact-name" type="date" name="blogdate" class="form-control" placeholder="Enter Blog Date" required="required"  >
                    </div>
                       <div class="form-group">
                      
                      Title of Blog:<input id="contact-name" type="text" name="blogtitle" class="form-control" placeholder="Enter Blog title*" required="required"  >
                    </div>
                       <div class="form-group">
                      Blog Description:<input id="contact-name" type="text" name="blogdesc" class="form-control" placeholder="Enter Blog Description*" required="required"  >
                    </div>
                       <div class="form-group">
                      Photographer Name:
