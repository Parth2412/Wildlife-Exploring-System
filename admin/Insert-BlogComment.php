...
if($_POST)
{
   ...
   $photographerid= $_POST['photographerid'];
    ...
    $q = mysql_query("insert into blog_comment (Blog_Comment_Date,Blog_Comment_Desc,User_Register_ID,Blog_ID,Photographer_Register_ID) values('{$blogcomment}','{$blogdesc}','{$userid}','{$blogid}','{$photographerid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Blog Comment Form</h2>
                  <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                        Blog Comment Date:<input id="contact-name" type="date" name="blogcomment" class="form-control" placeholder="Enter Blog Comment Date" required="required"  >
                    </div>
                       <div class="form-group">
                      
                      Blog Comment description:<input id="contact-name" type="text" name="blogdesc" class="form-control" placeholder="Enter Blog Description*" required="required"  >
                    </div>
                       <div class="form-group">
                      ...
                      Blog Title:
                      <select name="blogid" id="contact-name" class="form-control">
                          <?php
                          $q=  mysql_query("select * from blog") or die(mysql_error());
                          while($data=  mysql_fetch_row($q))
                          {
