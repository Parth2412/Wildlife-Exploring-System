...
if($_POST)
{
    ...
    $q = mysql_query("insert into photo_comment (Photo_Comment_Date,Photo_Comment_Desc,Photographer_Register_ID,Photo_ID,User_Register_ID) values('{$commentid}','{$commentdesc}','{$photographerid}','{$photoid}','{$userid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Photo Comment Form</h2>
             <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Photo Comment Date:<input id="contact-name" type="date" name="commentid" class="form-control" placeholder="Enter Date of Comment*" required="required"  >
                    </div>
                      <div class="form-group">
                      
                      Photo Comment Description:<input id="contact-name" type="text" name="commentdesc" class="form-control" placeholder="Enter Comment for Photo*" required="required"  >
                    </div>
                       <div class="form-group">
                      ...
                      Photo ID:
                       <select name="photoid" id="contact-name" class="form-control">
                          <?php
                          $q=  mysql_query("select * from photo") or die(mysql_error());
                          while($data=  mysql_fetch_row($q))
                          {
