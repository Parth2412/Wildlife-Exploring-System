...
if($_POST)
{
    ...
    $q = mysql_query("insert into photo_like (Photo_ID,Photographer_Register_ID,likes,User_Register_ID) values('{$photoid}','{$photographerid}','{$like}','{$userid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Photo Like Form</h2>
