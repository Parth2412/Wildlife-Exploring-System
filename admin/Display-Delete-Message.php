...
{
    $deleteid=$_GET['did'];
    mysql_query("delete from message where Message_ID='{$deleteid}'") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Display Messages</h2>
...
FROM
    ...
    INNER JOIN `project`.`message` 
        ON (`photographer_register`.`Photographer_Register_ID` = `message`.`Photographer_Register_ID`)
    INNER JOIN `project`.`user_register` 
        ON (`user_register`.`User_Register_ID` = `message`.`User_Register_ID`);") or die(mysql_error());
