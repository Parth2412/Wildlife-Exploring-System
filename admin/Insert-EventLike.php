...
if($_POST)
{
    $eventregisterid=$_POST['eventregisterid'];
    $userid=$_POST['userid'];
    $photographerid=$_POST['photographerid'];
    
    $q = mysql_query("insert into event_like (Event_Regitsraiton_ID,User_Register_ID,Photographer_Register_ID) values('{$eventregisterid}','{$userid}','{$photographerid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Event Like Form</h2>
                <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Event Registration ID:
                   <select name="eventregisterid" id="contact-name" class="form-control">
                          <?php
                          $q=  mysql_query("select * from event_registration") or die(mysql_error());
