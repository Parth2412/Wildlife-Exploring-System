<html>
       ...
       function CustomAlert()
        {
            this.render = function(dialog)
            {
                ...
                document.getElementById('dialogboxhead').innerHTML="Inserted";
            ...
            this.ok = function()
            {
                ...
                window.location.href="user_timeline_about_insert.php";
    ...
    <body>
        ...
        <script>Alert.render('Please Edit your profile...')</script>
    </body>
</html>
