...
{
    $deleteid=$_GET['did'];
    mysql_query("delete from blog where Blog_ID='{$deleteid}'") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h1 align="center" class="grey" >Display Blogs</h1>
...
FROM
    ...
    INNER JOIN `project`.`blog` 
        ON (`photographer_register`.`Photographer_Register_ID` = `blog`.`Photographer_Register_ID`);") or die(mysql_error());
                            $count=  mysql_num_rows($q);
                           # echo "<h4 class='grey'></h4>";
                            ...
                            {
                                echo "<tr>";
                                echo "<td >$data[0]</td><td>$data[1]</td><td>$data[2]</td><td>$data[3]</td><td>$data[4] $data[5]</td><td><a href=''><img src='./images/1284.png' width='30px'></a> | <a href='Display-Delete-Blog.php?did=$data[0]'><img src='./images/delete-128.png' width='30px'></a></td>";
