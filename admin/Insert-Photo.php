    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Photo Insertion Form</h2>
                     ...
                     Photographer Register ID :
                      <select name="photographerid" id="contact-name" class="form-control">
                       ...
                       <div class="form-group">
                           ...
                           Photo Upload Date & Time:<input id="contact-name" type="text" name="photodatetime" class="form-control" placeholder="Enter Photo Upload Date&Time*" required="required"  >
                    </div>
                        <div class="form-group">
