...
{
    $deleteid=$_GET['did'];
    mysql_query("delete from country where Country_ID='{$deleteid}'") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Display Country</h2>
                   ...
                   <?php
                         ...
                         #  echo "<h4 class='grey'>$count records found</h4>";
                            ...
                            {
                                echo "<tr>";
                                echo "<td >$data[0]</td><td>$data[1]</td><td><a href=''><img src='./images/1284.png' width='20px'></a> | <a href='Display-Delete-City.php?did=$data[0]'><img src='./images/delete-128.png' width='20px'></a></td>";
