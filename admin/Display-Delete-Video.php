...
{
    $deleteid=$_GET['did'];
    mysql_query("delete from videos where Video_ID='{$deleteid}'") or die(mysql_error());
...
<html lang="en">
  ...
  <body>
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Display Videos</h2>
    ...
    , `videos`.`Video_Upload_Dateandtime`
    , `videos`.`Spam_Count`
FROM
    `project`.`photographer_register`
    INNER JOIN `project`.`videos` 
        ON (`photographer_register`.`Photographer_Register_ID` = `videos`.`Photographer_Register_ID`);") or die(mysql_error());
