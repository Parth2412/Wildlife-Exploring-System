...
if($_POST)
{
    ...
    $q = mysql_query("insert into country (Country_Name) values('{$country}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Country Selection Form</h2>
                <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Country:<input id="contact-name" type="text" name="country" class="form-control" placeholder="Enter Country Name*" required="required"  >
                    </div>
