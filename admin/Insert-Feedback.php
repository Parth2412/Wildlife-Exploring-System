...
if($_POST)
{
    $feeedbackdate=$_POST['feeedbackdate'];
    $feedbackdesc=$_POST['feedbackdesc'];
    $userid=$_POST['userid'];
    $photographerid=$_POST['photographerid'];
    
    
    $q = mysql_query("insert into feedback (Feedback_Date,Feedback_Desc,User_Register_ID,Photographer_Register_ID) values('{$feeedbackdate}','{$feedbackdesc}','{$userid}','{$photographerid}')") or die(mysql_error());
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <h2 align="center" class="grey">Feedback Form</h2>
               <form class="contact-form" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                      
                      Feedback Date:<input id="contact-name" type="date" name="feeedbackdate" class="form-control" placeholder="Enter Feeedback Date*" required="required"  >
                    </div>
                      <div class="form-group">
                      
                      Feedback Description:<input id="contact-name" type="text" name="feedbackdesc" class="form-control" placeholder="Enter Description*" required="required"  >
                    </div>
                       <div class="form-group">
