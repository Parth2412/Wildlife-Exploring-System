...
if(isset($_GET["pid"]))
{
    mysql_query("insert into follow(User_Following_ID,Photographer_Following_ID,User_Register_ID,Photographer_Register_ID) values('0','".$_GET["pid"]."','$user_id','0')");
}
if(isset($_GET["uid"]))
{
    mysql_query("insert into follow(User_Following_ID,Photographer_Following_ID,User_Register_ID,Photographer_Register_ID) values('".$_GET["uid"]."','0','$user_id','0')"); 
}

if(isset($_GET["deletepid"]))
{
    mysql_query("delete from follow where Photographer_Following_ID='".$_GET["deletepid"]."' and User_Register_ID='$user_id'");    
    
}
if(isset($_GET["deleteuid"]))
{
    mysql_query("delete from follow where User_Following_ID='".$_GET["deleteuid"]."' and User_Register_ID='$user_id'");    
    
}


$check=mysql_query("select * from follow where User_Following_ID='$user_id'");
$final=0;
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand" href="user_homepage.php"><img class="logoimg" src="admin/images/wildlife/logo2.png" alt="logo" /></a>
          </div>
          <!-- Collect the nav links, forms, and other content for toggling -->
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="profile-card">
            	<img src="admin/photographers/<?php echo $user_grph['User_Picture']; ?>" alt="user" class="profile-photo" />
            	<h5><a href="timeline.html" class="text-white"><?php echo $user_grph['User_Fname'].$user_grph['User_Lname']; ?></a></h5>
             ...
             <ul class="nav-news-feed">
              ...
              <li><i class="icon ion-chatboxes"></i><div><a href="user_chatroom.php">Messages</a></div></li>
              <li><i class="icon ion-images"></i><div><a href="user_timeline_album.php">Images</a></div></li>
...
<!--            <div class="create-post">
            ...
            // $id=$_SESSION["Photographer_id"];
               $nearbypeople=  mysql_query("select *from photographer_register ");
                while($data=  mysql_fetch_row($nearbypeople))
                {
                    $rscheck=  mysql_query("select *from follow where Photographer_Following_ID='$data[0]' and User_Register_ID='$user_id'");
                        ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3">
                       <?php
                         ...
                         {
                       ?>
                      <a class="btn btn-primary pull-right" href="user_nearby.php?deletepid=<?php echo $data[0]; ?>">Unfollow</a>
                       <?php
                         }
                         else
                         {
                       ?>
                      <a class="btn btn-primary pull-right" href="user_nearby.php?pid=<?php echo $data[0]; ?>">Follow</a>
                       <?php
          ...
          <?php
              ...
              ?>
                 <?php
                  $id=$_SESSION["User_id"];
               $nearbypeople=  mysql_query("select *from user_register where User_Register_ID<>{$id}");
                while($data=  mysql_fetch_row($nearbypeople))
                {
                     $rscheck=  mysql_query("select *from follow where User_Following_ID='$data[0]' and User_Register_ID='$user_id'");
                        ?>
                <div class="nearby-user">
                <div class="row">
                  <div class="col-md-2 col-sm-2">
                  ...
                  <div class="col-md-3 col-sm-3">
                     <?php
                      ...
                      <a class="btn btn-primary pull-right" href="user_nearby.php?deleteuid=<?php echo $data[0]; ?>">Unfollow</a>
                     <?php
                         }
                         else
                         {
                      ...
                      <a class="btn btn-primary pull-right" href="user_nearby.php?uid=<?php echo $data[0]; ?>">Follow</a>
                     <?php
