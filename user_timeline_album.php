            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <ul class="list-inline profile-menu">
                    ...
                    <li><a href="user_timeline_album.php" class="active">Album</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <ul class="album-photos">
                 ...
                 <?php
                   $cn=new PDO("mysql:dbname=project","root","");
                   $rs=$cn->query("select * from photo_like pl,photo p where pl.Photo_ID=p.Photo_ID and User_Register_ID='{$user_id}'");
                // $rs = mysql_query("select * from photo_like pl,photo p where pl.Photo_ID=p.Photo_ID") or die(mysql_error());
                               
             while($photodata = $rs->fetch())
                {
                ...
                <li>
                  <div class="img-wrapper" data-toggle="modal" data-target=".photo-<?php echo $id; ?>">
                     <img src="admin/pphotos/<?php echo $photodata['Photo_URL']; ?>" alt="photo" style="width: 191px;height: 191px;" />
