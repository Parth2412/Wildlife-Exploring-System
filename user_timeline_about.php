...
<head>
    ...
    <script>
        ...
        {
            var varialble=document.getElementById('button1');
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <div class="about-profile">
                           <?php 
                           $editprofile=  mysql_query("select * from user_editprofile where User_Register_ID='{$user_id}'");
                           $editprofiledata=  mysql_fetch_array($editprofile);
                           if($editprofiledata==NULL)
                           {
                              
                               include 'admin/alertbox/personalinfo.php';
                           }
                           else
                           {
                           ?>      
                <div class="about-content-block">
                  ...
                  <p><?php echo $editprofiledata[1] ;?></p>
                </div>
                <div class="about-content-block">
                  ...
                  <div class="organization">
                    ...
                    <div class="work-info">
                      ...
                      <p><?php echo $editprofiledata[2];?></p>
                    </div>
                  </div>
<!--                  <div class="organization">
                    <img src="images/envato.png" alt="" class="pull-left img-org" />
                ...
                <div class="about-content-block">
                  ...
                  <p><?php echo $editprofiledata[3];?></p>
                  <div class="google-maps">
                   <!-- <div id="map" class="map"> -->
                       <iframe id="map" class="map" src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d58734.23938527773!2d72.51196435070001!3d23.064495451314198!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s<?php $editprofiledata[3]?>!5e0!3m2!1sen!2s!4v1488702604938" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe> 
                     <!-- </div> -->
                  </div>
                </div>
                <div class="about-content-block">
                ...
                <div class="about-content-block">
                  <h4 class="grey"><i class="ion-ios-chatbubble-outline icon-in-title"></i>Language</h4>
                    <ul>
                        <li><?php echo $editprofiledata[4];?></li>
