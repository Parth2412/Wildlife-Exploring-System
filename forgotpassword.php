...
if($_POST)
{
    ...
    if($is_photographer=='Photographer')
    {
        ...
        $q = mysql_query("SELECT * FROM `photographer_register` where Photographer_Email ='{$loginemail}'") or die(mysql_error());
    ...
    if($data>0)
    {
        ...
        $mail->Username = 'wildlifesystem@gmail.com';                 // SMTP username
        $mail->Password = 'Wildlife@12345';                           // SMTP password
        ...
        $mail->Body    = "Hi $loginemail Your Password is $data[7]";
    ...
    else
    {
        ...
        $q = mysql_query("SELECT * FROM `user_register` where User_Email ='{$loginemail}'") or die(mysql_error());
    $data = mysql_fetch_row($q);
    if($data>0)
    {
