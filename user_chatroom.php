...
<!--              <ul class="online-users list-inline">
   ...
   <ul class="online-users list-inline">
       ...
       $rsonline= mysql_query("select *from follow  where User_Following_ID='$user_id'");
                               ...
                               if($rdonline[4]=='0')
                               {
                                   $rsuser=  mysql_query("select *from user_register where User_Register_ID='$rdonline[3]'");
                                     $data=  mysql_fetch_row($rsuser);
                                           ?>
                <li><a href="#" title="Linda Lohan"><img src="admin/photographers/<?php echo $data[9]; ?>" alt="user" class="img-responsive profile-photo" />
                                             <?php
                           if($data[10]=="yes")
                           {
                         ?>
       ...
       $rsonline= mysql_query("select *from follow  where User_Register_ID='$user_id'");
